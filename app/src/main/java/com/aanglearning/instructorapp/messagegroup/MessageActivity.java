...
import com.aanglearning.instructorapp.messagerecipient.MessageRecipientActivity;
        ...
        public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
            switch (item.getItemId()) {
                case R.id.action_delete:
                    if(teacher.getId() == adapter.getDataSet().get(selectedMessagePosition).getSenderId()) {
                        ...
                        showSnackbar("You can only delete message sent by you!");
                    }
                    return true;
