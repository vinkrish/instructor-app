...
import com.aanglearning.instructorapp.util.GridSpacingItemDecoration;
    ...
    private void saveBitmapToFile() {
        try {
            ...
            File dir = new File(Environment.getExternalStorageDirectory().getPath(),
                    "Shikshitha/Teacher/" + teacher.getSchoolId());
            if (!dir.exists()) {
                dir.mkdirs();
            }
    ...
    public void albumImagesDeleted(ArrayList<DeletedAlbumImage> albumImages) {
        ...
        for(DeletedAlbumImage deletedAlbumImage: albumImages) {
            File file = new File(Environment.getExternalStorageDirectory().getPath(),
                    "Shikshitha/Teacher/" + teacher.getSchoolId() + "/" + deletedAlbumImage.getName());
            if(file.exists()) {
                file.delete();
            }
        }
